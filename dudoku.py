...
class Dudoku():
    ...
    def draw_cells(self):
        for i in range(1, 10):
            for j in range(1, 10):
                    arcade.draw_rectangle_outline(i * self.cell_width - self.cell_width / 2 , j * self.cell_height - self.cell_height / 2, self.cell_width, self.cell_height, arcade.color.BRITISH_RACING_GREEN, 1)
    ...
    def draw_playground(self):
        arcade.draw_rectangle_outline(self.cell_width * 9 - (self.cell_width * 9) / 2, self.cell_height * 9 - (self.cell_height * 9) / 2, self.cell_width * 9, self.cell_height * 9, arcade.color.BRITISH_RACING_GREEN, 10)
        self.draw_cells()
        self.draw_bigcells()